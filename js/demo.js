        ...
        var chart = new Highcharts.Chart({
            ...
            tooltip: {
                ...
                formatter: function () {
                    ...
                    return '<div style="border: 2px solid ' + this.color + ';"><span style="font-size: 10px; color: #000000; font-family: arial;">' + this.key + '</span><br/><b>Occurrence Limit</b>' + d['Occurrence Limit'] + '<br/><b>Aggregate Limit: </b>' + d['Aggregate Limit'] + '<br/><b>Deductible: </b>' + d['Deductible'] + '</div>';
                }
            },
            plotOptions: {
                pie: {
